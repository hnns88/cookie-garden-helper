...
- dying:
  - if the plant is dying, and the option **Dying plants** is **ON**, and the current CpS multiplier
  is above or equal to the one specified at **Dying Mini CpS multiplier**
